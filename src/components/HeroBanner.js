        ...
        <div className="flex flex-wrap">
          <div className="w-full self-center px-4 lg:w-1/2">
            ...
            <span className="font-semibold block text-lg text-cyan-800 dark:text-cyan-500  mt-2">
              Web Developer{" "}
              <span className="text-black dark:text-slate-300"> & Blogger</span>
            </span>
            <p className="font-medium text-secondary py-8 max-w-lg dark:text-textDark">
              ...
              over 2 years with a demonstrated history of working in the
              information technology and IT services industry
            </p>

            <div className="mt-4 flex">
              <a
                href="https://www.linkedin.com/in/ikhbal-dwiyantoro-536693199/"
                className="text-base font-semibold text-white bg-gradient-to-r from-primary to-sky-500 py-3 px-6 rounded-xl hover:shadow-lg hover:opacity-70 transition duration-200 ease-in-out mr-5 inline"
                target="_blank"
              >
              ...
              <a
                ...
                className="text-base font-semibold text-white bg-black dark:bg-slate-600 py-3 px-6 rounded-xl hover:shadow-lg hover:opacity-70 transition duration-200 ease-in-out"
                target="_blank"
              >
