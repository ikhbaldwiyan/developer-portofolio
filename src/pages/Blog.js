        ...
        <div className="container">
          <div className="w-full px-4">
            <div className="max-w-xl">
              <h4 className='font-bold text-2xl text-black dark:text-textDark uppercase'>Latest Articles</h4>
            </div>
          </div>
                ...
                <div className="bg-white dark:bg-gray-700 rounded-xl overflow-hidden shadow-lg">
                  ...
                  <div className="py-6 px-6">
                    <Link to={slugify(item.title)} state={articleState(item)}>
                      <a className='text-black dark:text-cyan-500 dark:font-semibold hover:text-primary font-semibold text-xl truncate'>
                        {item.title}
                      </a>
                    </Link>
                    <p className='py-5 text-semibold text-secondary dark:text-textDark'>
                      {item.desc}
                    </p>
                    <Link to={slugify(item.title)} state={articleState(item)}>
                      <a className="py-2 px-5 bg-gradient-to-r font-semibold from-primary to-sky-500 text-white dark:text-textDark rounded-lg hover:opacity-70">
                        Read More
                      </a>
                    </Link>
                  </div>
